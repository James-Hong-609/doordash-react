...
class Brand extends React.Component {
  render () {
    return (
      <div className='min-w-220px justify-center max-w-full flex items-center flex-row'>
        <div className='max-w-full flex items-center justify-start flex-row' style={{opacity:1, visibility:'visible'}}>
          <div data-testid="HomeLogo" className='flex-1 flex justify-center relative right-0 left-0 m-auto bg-white'>
            <a className="decoration-inherit cursor-pointer" data-accessibility-id="header-homepage-link" aria-label="DoorDash Home Page">
              <div className="max-w-full flex items-center justify-start flex-row">
                <svg aria-hidden="true" width="32" height="18" viewBox="0 0 99.5 56.5" fill="red">
                ...
                <div className="leading-0 ml-2">
                  <svg aria-hidden="true" width="112" height="13" viewBox="0 0 361.1 42" fill="red">
                ...
                <span className="absolute left-tmp top-auto w-px h-px overflow-hidden">DoorDash
                </span>
              </div>
            </a>
          </div>
